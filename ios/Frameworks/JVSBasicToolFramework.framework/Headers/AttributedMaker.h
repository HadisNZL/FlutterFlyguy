...
- (AttributedMaker *(^)(UIFont *value, NSRange range))fontRange;
///设置斜体
- (AttributedMaker *(^)(float value))obliqueness;
///设置文字颜色
- (AttributedMaker *(^)(UIColor *value))foregroundColor;
- (AttributedMaker *(^)(UIColor *value, NSRange range))foregroundColorRange;
///设置背景颜色
...
///下滑线样式
- (AttributedMaker *(^)(NSUnderlineStyle value))underlineStyle;
///下滑线颜色
...
/// 段落间距
- (AttributedMaker *(^)(float value))paragraphSpacing;
///对齐方式
