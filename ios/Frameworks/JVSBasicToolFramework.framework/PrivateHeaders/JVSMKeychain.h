...
/**
 Error code specific to JVSMKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, JVSMKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	JVSMKeychainErrorBadArguments = -1001,
};

/** JVSMKeychain error domain */
extern NSString *const kJVSMKeychainErrorDomain;

/** Account name. */
extern NSString *const kJVSMKeychainAccountKey;
 ...
 */
extern NSString *const kJVSMKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kJVSMKeychainClassKey;

/** Item description. */
extern NSString *const kJVSMKeychainDescriptionKey;

/** Item label. */
extern NSString *const kJVSMKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kJVSMKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kJVSMKeychainWhereKey;
...
/**
 ...
 JVSMKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface JVSMKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in JVSMKeychain.h for a list of keys that can be used when accessing the
