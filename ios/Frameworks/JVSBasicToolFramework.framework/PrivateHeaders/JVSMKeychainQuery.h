...
typedef NS_ENUM(NSUInteger, JVSMKeychainQuerySynchronizationMode) {
	JVSMKeychainQuerySynchronizationModeAny,
	JVSMKeychainQuerySynchronizationModeNo,
	JVSMKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface JVSMKeychainQuery : NSObject
...
@property (nonatomic) JVSMKeychainQuerySynchronizationMode synchronizationMode;
#endif
